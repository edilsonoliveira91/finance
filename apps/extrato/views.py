...
from apps.perfil.models import Conta, Categoria
...
def view_extrato(request):
    ...
    todos_lancamentos = request.GET.get('todos-lancamentos')
    ...
    return render(request, 'view_extrato.html', {'contas': contas, 'categorias': categorias, 'valores': valores, 'periodo': periodo})
